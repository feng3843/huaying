...
@interface CCTVListVC ()<NSXMLParserDelegate,UITableViewDataSource,UITableViewDelegate>
...
-(void)requestList:(id)sender{
    ...
    NSStringEncoding gbEncoding = CFStringConvertEncodingToNSStringEncoding(kCFStringEncodingGB_18030_2000);
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"http://www.cctv1zhibo.com/%@/%d/",self.href,self.pageNum]];
