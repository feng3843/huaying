...
@interface RYZRViewController ()<NSXMLParserDelegate,UITableViewDataSource,UITableViewDelegate>
...
@implementation RYZRViewController{
...
-(void)requestList:(id)sender{
    ...
    NSStringEncoding gbEncoding = CFStringConvertEncodingToNSStringEncoding(kCFStringEncodingGB_18030_2000);
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"http://www.cctv1zhibo.com/renyuziran/%d/",self.pageNum]];
