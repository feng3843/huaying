...
#import "DwsjStaticViewController.h"
...
@interface DwsjStaticViewController ()<NSXMLParserDelegate,UITableViewDataSource,UITableViewDelegate>
...
@implementation DwsjStaticViewController{
...
- (void)viewDidLoad {
    ...
    if (@available(iOS 11.0, *)) {
        ...
        NSString *path = [[NSBundle mainBundle] pathForResource:@"dwsj.plist" ofType:nil];
        NSArray *array = [NSArray arrayWithContentsOfFile:path];
        self.items = [DWSJModel mj_objectArrayWithKeyValuesArray:array];
}
