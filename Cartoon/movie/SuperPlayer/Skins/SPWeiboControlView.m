...
- (void)makeSubViewsConstraints {
    ...
    [self.videoTitleLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.equalTo(self.backBtn);
...
-(UILabel *)videoTitleLabel{
    if (!_videoTitleLabel) {
        ...
        _videoTitleLabel.font          = [UIFont systemFontOfSize:15.0f];
...
- (void)setOrientationLandscapeConstraint {
    ...
    [self.videoTitleLabel mas_remakeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(self.backBtn.mas_bottom).offset(-30);
        make.left.mas_equalTo(self.backBtn.mas_right).offset(10);
        make.trailing.mas_equalTo(self.muteBtn.mas_leading).offset(-10);
    }];
}
