...
#define historePath [NSHomeDirectory() stringByAppendingPathComponent:@"Documents/wanmeihistory.plist"]
...
-(void)requestSearchWithKey:(id)sender{
    ...
    NSString *url = [[NSString stringWithFormat:@"http://jrys.wy2sf.com:8056/yingshi/searchForHanZi?keys=%@&page=%d&pageSize=20",keyWord,_page] stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
    [XPNetWorkTool requestWithType:HttpRequestTypeGet withHttpHeaderFieldDict:nil withUrlString:url withParaments:nil withSuccessBlock:^(NSDictionary *responseObject) {
        ...
        NSMutableArray *array = [WMModel mj_objectArrayWithKeyValuesArray:responseObject[@"data"]];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    WMModel *model = self.dataList[indexPath.row];
    cell.wmModel = model;
